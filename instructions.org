...
#+BEGIN_SRC
cd ~/workspace/rdma_anns
./build/src/state_send/convert_parlayann_graph_file /mydata/local/anngraphs/bigann/1B/vamana_64_128_1.2 /mydata/local/anngraphs/bigann/1B/global_partitions_10/pipeann_1B_partition0.bin /mydata/local/anngraphs/bigann/1B/global_partitions_10/pipeann_1B_graph
#+END_SRC
* Cloudlab setup
