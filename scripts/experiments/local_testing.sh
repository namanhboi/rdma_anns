...
SEND_RATE=0
BASE_EXPERIMENT_NAME=local_testing_${DATASET_NAME}_${DATASET_SIZE}
...
# DIST_SEARCH_MODE_LIST=("STATE_SEND" "STATE_SEND_CLIENT_GATHER" "SCATTER_GATHER")
# DIST_SEARCH_MODE_LIST=("STATE_SEND_CLIENT_GATHER")
# DIST_SEARCH_MODE_LIST=("STATE_SEND")

# DIST_SEARCH_MODE_LIST=("SCATTER_GATHER")
