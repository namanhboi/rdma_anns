...
$SCRIPT_DIR/run_experiment.sh batch_size_8 2 bigann 100M SCATTER_GATHER distributed 8 8 false
$SCRIPT_DIR/run_experiment.sh batch_size_8 3 bigann 100M SCATTER_GATHER distributed 8 8 false
$SCRIPT_DIR/run_experiment.sh batch_size_8 4 bigann 100M SCATTER_GATHER distributed 8 8 false
$SCRIPT_DIR/run_experiment.sh batch_size_8 5 bigann 100M SCATTER_GATHER distributed 8 8 false
